...
#define O(r0, r1, r2, r3, o, b) ((void *)(const void *[]){r0, r1, r2, r3, o, b})
#define T(...)                                                                 \
  ((void *)&((const void *[]){                                                 \
...
V(α, T("a", dim), T(ε), T(ε), T(ε))
V(β, T("b", dim), T(ε), T(ε), T(ε))
V(χ, T("x", dim), T(ε), T(ε), T(ε))
V(αβ, T(α), T(β), T(ε), T(ε))
V(S, T(β), T(S, α), T(S, β), T(S, χ))
...
V(E, T(α), T(oprn, E, cprn), T(E, mul, E), T(E, plus, E))
// s ::= np vp | s pp
